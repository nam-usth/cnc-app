...
def reset():
    ...
    return val_max, search_flg, sharpness, sharpness_list, peak_list, total_frame, mse_list 
...
def API_nose_phase_measurement_slow_streaming(source, stop_flg):    
    ...
    if stop_flg != 1:
        ...
        val_max, search_flg, sharpness, sharpness_list, peak_list, total_frame, mse_list = reset()
